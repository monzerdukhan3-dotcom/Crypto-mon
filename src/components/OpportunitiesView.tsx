...
// Cap on how many "approaching" rows to render — with 60 coins × 4
    ...
    <div className="flex w-full max-w-4xl flex-col gap-6">
      <div className="relative overflow-hidden rounded-xl border border-surface-border bg-surface p-5 shadow-sm transition-shadow duration-200 hover:shadow-md">
        ...
        <p className="text-sm leading-relaxed text-muted">
          مسح تلقائي حي لأعلى 60 عملة على الأطر الزمنية الأربعة كلها — يعرض أي عملة وصل سعرها الآن لمنطقة طلب
